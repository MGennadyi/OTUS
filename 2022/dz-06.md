...
```
sudo -u postgres pgbench -p 6432 -i -d otus -h 192.168.5.166

# Аристов: если указать не сущ.бд, то pgbouncer умрет. Небходимо включить рестарт сервиса при падении.
```
