...
listen postgres_write
    ...
    server pgsql1 10.166.0.5:6432 check port 8008
    server pgsql2 10.166.0.4:6432 check port 8008
    server pgsql3 10.166.0.3:6432 check port 8008
...
listen postgres_read
    ...
    http-check expect status 200
    default-server inter 10s fall 3 rise 3 on-marked-down shutdown-sessions
    server pgsql1 192.168.5.165:6432 check port 8008
    server pgsql2 192.168.5.166:6432 check port 8008
    server pgsql3 192.168.5.167:6432 check port 8008
```
```
