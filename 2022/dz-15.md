...
gpadmin@gp1:~$
```
###### Проверка доступности gp3 gp4 gпо портам:
```
...
# Но если не в директории gpconfigs, то будет ругаться, поэтому:
sudo mkdir /home/gpadmin/gpconfigs
sudo vim /home/gpadmin/gpconfigs/hostfile_gpinitsystem
```
...
PostgreSQL 9.4.26 (Greenplum Database 6.21.0 build commit:d0087e3b24c54d203ca8bb315559205f13cd6393 Open Source) on x86_64-unknown-linux-gnu, compiled by gcc (Ubuntu 7.5.0-3ubuntu1~18.04) 7.5.0, 64-bit compiled on Jun 10 2022 01:58:25
