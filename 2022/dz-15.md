...
echo ~/.bashrc
# Ответ:
20220801:06:08:21:000934 gpstart:gp1:gpadmin-[INFO]:-Starting gpstart with args: 20220801:06:08:21:000934 gpstart:gp1:gpadmin-[INFO]:-Gathering information and validating the environment...
20220801:06:08:21:000934 gpstart:gp1:gpadmin-[CRITICAL]:-gpstart failed. (Reason  ='Environment Variable MASTER_DATA_DIRECTORY not set!') exiting...
```
###### Вход в postgresql:
```
gpadmin@gp1:~$ psql
