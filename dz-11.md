...
###### Desc: Postgresql 12. ВМ1, ВМ2, ВМ3, ВМ4 ip=33,34,32,31. По умолчанию #listen_addresses = 'localhost', поэтому, пренебрегая безопасностью активируем и правим на '*' :
```
vim /etc/postgresql/12/main/postgresql.conf
sudo pg_ctlcluster 12 main restart
```
###### Проверяем доступность c ip=33:
```
